...
const s = {
  ...
  centeredLoading: {
    ...
    color: "var(--text-secondary)", fontSize: "13px", background: "var(--bg)",
  },
  body: {
    display: "grid", gridTemplateColumns: "270px 1fr", flex: 1,
    overflow: "hidden", height: "calc(100vh - 53px)",
  },
  sidebar: {
  ...
  indexPill: {
    display: "flex", alignItems: "center", gap: "7px", margin: "10px 12px",
    ...
    <div style={s.app}>
      <div style={s.topbar}>
        <div style={s.brand}>
          ...
          <span style={s.brandText}>Docu<span style={s.brandAccent}>Mind</span></span>
        </div>
